    ...
    return (
        <div>
            <footer className="footer xl:px-24 py-10 px-4 text-base-content">
                <aside>
                    <a href='/' className='text-green font-bold text-3xl'>EatUp</a>
                ...
                <nav>
                    ...
                    <a className="link link-hover">adesinamubarak123@email.com</a>
                    <a className="link link-hover">+234 815 310 1044</a>
