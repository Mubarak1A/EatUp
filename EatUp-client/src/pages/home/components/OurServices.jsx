                ...
                <div className='md:w-1/2'>
                    <div className='text-left md:w-4.5/5'>
                        ...
                        <p className='my-5 text-secoundary leading-[30px]'>
                            Rooted in passion, we curate unforgettable dinning experience and offer exceptional services,
                    ...
                    <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                        {
                            serviceLists.map((service) => [
                                <div key={service.id}
                                    className="shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-green 
